...
<body>
    ...
    <div class="main_box">
		  ...
		  <div class="donate_collection_details">
			    <div class="donate_img">
			   		<a href><img src="${collection.img}" alt="rainforest" style="width: 100%; height: 100%;"></a>
			    </div>
			    <div class="donate_collection_det">
			        <div class="single_collection_title">${collection.title}</div>
			        <div class="single_collection_description">${collection.description}</div>
			     </div> 
		 </div>
		 	
		 	<div class="donate_collection_values">Collected: ${collection.collected}/${collection.amount}</div> 
            ...
            %>
		 	...
		 	<div class="donate_collection_values">Donate Charity points:</div>
		 	<div class="donate_button">
			 	<form action="/collections/${id}/donateSuccess" method="post">
				
					<input type="number" name="donation" placeholder="donation" />
					<input type="submit" value="donation" class="button" /> <br>
					<br>
				</form>
		 	 </div> 
		 	<%
